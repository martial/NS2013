var Roof_01 = Animation.extend({
    ...
    update: function (s) {
        ...
        lookAt(s, 30, pos.x, pos.y, depth);
        
        var pos = getSharpyPos(s, 13);
        lookAt(s, 29, pos.x, pos.y, 0);
        
        var pos = getSharpyPos(s, 12);
        lookAt(s, 13, pos.x, pos.y, depth);
        
        var pos = getSharpyPos(s, 28);
        lookAt(s, 12, pos.x, pos.y, 0);
        
        var pos = getSharpyPos(s, 27);
        lookAt(s, 28, pos.x, pos.y, depth);
        
        var pos = getSharpyPos(s, 11);
        lookAt(s, 27, pos.x, pos.y, 0);
        
        var pos = getSharpyPos(s, 10);
        ...
        lookAt(s, 20, pos.x, pos.y, depth);
        
        var pos = getSharpyPos(s, 3);
        lookAt(s, 19, pos.x, pos.y, 0);
        
        var pos = getSharpyPos(s, 2);
        lookAt(s, 3, pos.x, pos.y, depth);
        
        var pos = getSharpyPos(s, 18);
        lookAt(s, 2, pos.x, pos.y, 0);
        
        var pos = getSharpyPos(s, 17);
        lookAt(s, 18, pos.x, pos.y, depth);
        
        var pos = getSharpyPos(s, 1);
        lookAt(s, 17, pos.x, pos.y, 0);
        
        var pos = getSharpyPos(s, 0);
